...
const countries_abbreviations = require('./assets/countries_abbreviations.json')
  ...
  run: async(client, message, args) => {
    if (!args[0]) {
      ...
      const embed = new MessageEmbed()
        .setAuthor('Coronavirus Stats', message.author.displayAvatarURL())
      ...
      const embed = new MessageEmbed()
        ...
        .setThumbnail(`https://www.countryflags.io/${countries_abbreviations[country.country]}/flat/64.png`)
        .setColor('#9933ff')
        .setFooter(`Last Updated: ${updatedTime}`);
